...
syn keyword cppTest	TEST_F EXPECT_CALL EXPECT_TRUE ASSERT_TRUE ASSERT_THAT
syn match cppTest	"\(MOCK_METHOD\|MOCK_CONST_METHOD\)[1-9]"
syn match cppTest	"MATCHER_P[1-9]"

syn keyword cppType		CPLANE_DEBUG CPLANE_INFO CPLANE_ERROR
...
if version >= 508 || !exists("did_cpp_syntax_inits")
  ...
  HiLink cppBoost		Special
  HiLink cppTest		Identifier
